...
export default function AppLayout({
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 transition-colors duration-200">
            <Navbar />
            {/* Mobile Header — extends behind iOS status bar */}
            <div
                className="md:hidden fixed top-0 left-0 right-0 z-50 ios-blur border-b border-white/20 dark:border-slate-800/20 flex flex-col justify-end"
                style={{
