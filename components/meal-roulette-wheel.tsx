...
export function MealRouletteWheel({ meals, onSelectMeal, onClose }: MealRouletteWheelProps) {
  ...
  const spin = useCallback(() => {
    ...
    // Pointer at top sees angle `currentRotation % 360` in original wheel space.
    // Wedge i's center is at `(i + 0.5) * anglePer` degrees.
    ...
    // Ensure at least half a wedge of visible movement
